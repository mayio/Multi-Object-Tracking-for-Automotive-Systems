% my solution for pruning and capping, merging
...
classdef hypothesisReduction
    ...
    methods (Static)
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure
            selection        = hypothesesWeight > threshold;
            hypothesesWeight = hypothesesWeight(selection);
            multiHypotheses  = multiHypotheses(selection);                        
        end
        ...
        function [hypothesesWeight, multiHypotheses] = ...
            ...
            %       1 structure
            if (M < length(hypothesesWeight))
               [weights_sorted, weights_index] = ... 
                   sort(hypothesesWeight, 'descend');
               hypothesesWeight = weights_sorted(1:M);
               weights_index = weights_index(1:M);
               multiHypotheses = multiHypotheses(weights_index);
            end
        end
